...
export * from './lib/modals/modal-menu-tree/modal-menu.interfaces';

export * from './lib/modals/teacher-contact-modal/teacher-contact-modal.component';
export * from './lib/modals/teacher-contact-modal/teacher-contact-data-config';
