    ...
    steps: [
...

      {
        ...
        stepGroupForm: {
          ...
          controls: {
            ...
            city: StudentControls.City(this.staticEntitiesDataQuery.getCities()),
          },
        },
        stepButtons: [
          {
      ...
      },
      {
        ...
        stepGroupForm: {
          ...
          styleStructure:'style-grid',
          controls: {
            college: StudentControls.College(this.staticEntitiesDataQuery.getColleges()),
            studyprogram: StudentControls.Studyprogram(this.staticEntitiesDataQuery.getStudyPrograms()),
